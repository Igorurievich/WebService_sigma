...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['connectionHub'].server = {
            ...
            getZoneAsync: function (user_Id) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["GetZoneAsync"], $.makeArray(arguments)));
            },

            getZoneDevice: function (zoneOrdevice_id) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["GetZoneDevice"], $.makeArray(arguments)));
            },
            ...
            removeAllTimeActiveAsync: function (zone_id) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["RemoveAllTimeActiveAsync"], $.makeArray(arguments)));
            },

            removeTimeActiveAsync: function (zone_id) {
            ...
            removeZoneDeviceAsync: function (id) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["RemoveZoneDeviceAsync"], $.makeArray(arguments)));
            },

            returnDeviceConfiguration: function (token, obj) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["ReturnDeviceConfiguration"], $.makeArray(arguments)));
            },
            ...
            setDeviceConfiguration: function (token, obj) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["SetDeviceConfiguration"], $.makeArray(arguments)));
            },
            ...
            setNameDeviceAsync: function (id, name) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["SetNameDeviceAsync"], $.makeArray(arguments)));
            },
            ...
            setZoneAsync: function (user_id, description, poligons) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["SetZoneAsync"], $.makeArray(arguments)));
            },

            setZoneDeviceAsync: function (zone_id, d_id) {
                return proxies['connectionHub'].invoke.apply(proxies['connectionHub'], $.merge(["SetZoneDeviceAsync"], $.makeArray(arguments)));
            },
